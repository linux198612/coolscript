...
<div class="row">
	...
	if(time() < $nextClaim){
		header("Location: index.php?page=faucet");
		exit;
	}
	...
	if(isset($_POST['verifykey'])){
			...
			echo "<h1>2. Solve Captcha</h1><br />
			<form method='post' action='index.php?page=faucet&c=1'>
		...
		echo alert("danger", "Abusing the system is not allowed. <a href='faucet.php'>Go back</a>");
	}
